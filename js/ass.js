! function() { let t, e = !1,
  ...
  function _() { return "light" === l ?
      ...
      "reading-comfort" === l ?
      { bg: "#f4f1ea", text: "#242424",
        accent: "#667c6a",
        border: "#d6d3ca",
        card: "#ffffff",
        shadow: "rgba(102,124,106,0.2)" } :
      "custom" === l ? { bg: x
          .background, text: x.text,
        accent: x.accent, border: x
          .border, card: x.cardBg,
  ...
  function v() { if (c) return; let t =
    ...
    t.onload = () => { c = !0 }, t
      ...
      document.head.appendChild(t) } let
    k = document.createElement("div");
  k.innerHTML =
    '<i class="fas fa-universal-access"></i>',
    k.style.cssText =
    "position:fixed;right:15px;top:50%;transform:translateY(-50%);width:50px;height:50px;background:linear-gradient(135deg,#BB86FC,#9C27B0);border-radius:50%;display:flex;align-items:center;justify-content:center;cursor:pointer;z-index:9999;transition:all 0.4s cubic-bezier(0.4,0,0.2,1);box-shadow:0 4px 15px rgba(187,134,252,0.4);color:#000;font-size:20px;will-change:transform;"; let
    w = document.createElement("div");
  w.id = "notificationContainer", w
    .style.cssText =
    "position:fixed;bottom:20px;left:50%;transform:translateX(-50%);z-index:9998;display:flex;flex-direction:column-reverse;gap:8px;max-width:320px;width:80%;pointer-events:none;"; let
    B = document.createElement("div");
  B.style.cssText =
    "position:fixed;top:0;left:0;width:100vw;height:100vh;background:rgba(0,0,0,0.8);backdrop-filter:blur(10px);z-index:10000;display:none;align-items:center;justify-content:center;opacity:0;transition:all 0.4s cubic-bezier(0.4,0,0.2,1);will-change:opacity;"; let
    C = document.createElement("div");
  C.style.cssText =
    "position:fixed;top:0;left:0;width:100vw;height:100vh;background:#1a1a1a;z-index:11000;display:none;opacity:0;transition:all 0.4s cubic-bezier(0.4,0,0.2,1);overflow-y:auto;-webkit-overflow-scrolling:touch;"; let
    E = document.createElement("div");
  
  function z(t, e, o = 5e3, a =
  null) { if (!g || s) return;
    b++; let i = document.createElement(
        "div"),
      r = "notif-" + Date.now() + "-" +
      b,
      n = _();
  ...
  return; let t = () => { if (y
        ...
        function t(e) { if (!$ || s ||
          ...
          a.id = i; let n =
            ...
            l =
            `<i class="fas fa-bullhorn" style="color:${r.accent};font-size:12px;" title="Sponsored"></i>`; "popup" ===
    ...
    continue; if ((currentChunk + ' ' +
        ...
        maxLength) { currentChunk =
          ...
          .length > maxLength) { let
            ...
            tempChunk } else { currentChunk
            = sentence } } } if (
      currentChunk) chunks.push(
      currentChunk); return chunks }
  
  function speakTextQueue() { if (
      currentSpeechIndex >= speechQueue
      .length) { isSpeechPlaying = !1,
  ...
  function stopSpeech() { isSpeechPlaying
  ...
  function j(t, e) { if (!t) return; let
      o = document.getElementById(
  ...
  function H() { if (!c) { z(
        ...
        3e3), v(), setTimeout(H,
      3e3); return } let t = document
      .getElementById(
      "readingContent"); if (!t || !
      window.html2canvas) { z(
        "PNG Error",
        "Unable to capture PNG. Please try again.",
        4e3); return } let e = t
      .cloneNode(!0);
    e.querySelectorAll("iframe")
      .forEach(t => { let e = document
          .createElement("div");
        e.style.cssText =
      ...
      document.body.appendChild(e); let
      o = document.getElementById(
        "pngButton"),
      a = o.innerHTML;
    o.innerHTML =
      ...
      e, { backgroundColor: d ?
          "#1a1a1a" : "#f4f1ea",
        useCORS: !0, allowTaint: !1,
        scale: 2, width: t
          .scrollWidth, height: t
          .scrollHeight, onclone(
        t) { let e = t.getElementById(
            "readingContent");
          e && j(e, d) } }).then(
      t => { t.toBlob(t => { let e =
              URL.createObjectURL(
  ...
  function M() { let t = window
      .innerWidth <= 768,
      e = window.innerWidth <= 1024 &&
      window.innerWidth > 768; if (
      t) { E.style.width = "95vw", E
  ...
  function N() { stopSpeech(), s = !1, C
      .style.opacity = "0"; let t =
      document.getElementById(
        "readingModeStyles");
  ...
  function O(t) { document
    ...
    t) { S.apply(console, t), z(
        "Console Log", t.join(" "),
        4e3) }, console.error =
    function(...t) { L.apply(console,
        t), z("Console Error", t.join(
          " "), 6e3) }, console.warn =
    function(...t) { F.apply(console,
        t), z("Console Warning", t.join(
          " "), 5e3) }, B.appendChild(
    E), document.body.appendChild(k),
    document.body.appendChild(w),
    document.body.appendChild(B),
    document.body.appendChild(C); let X,
    G = (t = W, function e(...o) { let
        a = () => { clearTimeout(X),
            t(...o) };
      clearTimeout(X), X = setTimeout(
        a, 100) });
  
  function U(t, e, o) { let a = document
      .getElementById(t);
    a && a.addEventListener("change",
      t => { window[e] = t.target
          .checked; let a = t.target
          .nextElementSibling
          ?.children[0];
    ...
    ?.addEventListener("click",
      function t() { y.forEach(t =>
          removeAd(t)); let e = document
          .getElementById(
    ...
    ?.addEventListener("click",
      function t() { if (!(
          ...
          document.getElementById(
            "readingContent"); if (!e)
          return; if (isSpeechPlaying ||
          p) { stopSpeech
        (); return } let o = e
          .textContent || ""; if (0 ===
          o.length) { z("No Content",
            "No text content found to read",
            3e3); return } speechQueue =
  ...
  E.querySelectorAll(
    'div[style*="background:rgba(187,134,252,0.1)"]'
      ...
      V.observe(t) }); let J = window
    .matchMedia(
      "(prefers-reduced-motion: reduce)"
      );
  
  function Q(t) { let e = t.matches ?
      "none" :
      "all 0.4s cubic-bezier(0.4,0,0.2,1)";
    [k, B, E, C].forEach(t => { t && (t
        .style.transition = e) }) } J
    .addListener(Q), Q(J),
